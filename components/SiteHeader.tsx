            ...
            <nav className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-8 text-sm font-bold uppercase tracking-widest text-white items-center w-full md:w-auto px-8 md:px-0">
              ...
              <Show when="signed-out">
                <SignInButton mode="modal">
                  <button className="text-white hover:text-[#FFD700] transition font-bold uppercase tracking-widest text-xs">Log In</button>
                </SignInButton>
                <SignUpButton mode="modal">
                  <button className="bg-[#FFD700] text-[#800000] px-5 py-2 rounded-full hover:bg-white hover:scale-105 transition shadow-lg font-bold uppercase tracking-widest text-xs">Sign Up</button>
                </SignUpButton>
              </Show>
              <Show when="signed-in">
                <UserButton />
